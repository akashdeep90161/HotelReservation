...
public class TestUser {
    ...
    public void setup() throws Exception
    {
        ...
        ResultActions resultActions=mvc.perform(get("/user/login").header("X_AUTH_USER","aman@gmail.com").header("X_AUTH_PASS","qwerty")
    ...
    public void testRegisterUser() throws Exception {
        ...
        user.setPass(HashMapUtils.getAlphaNumericString());
        ...
        ResultActions response=mvc
                .perform(post("/user/register")//.header("X_AUTH_USER","abc@gmail.com").header("X_AUTH_TOKEN",Auth_Token)
                .contentType(APPLICATION_JSON)
                .content(jsonUser
                        .write(user)
                        .getJson()))
